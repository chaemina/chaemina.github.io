...
# 구조체 
구조체와 클래스는 타입을 정의한다. 구조체와 클래스의 차이는 [해당 글](https://chaemina.github.io/docs/swift/class/)에서 설명한다.
{: .fs-6 .fw-300 }
...
> 구조체 Student 
>
> 인스턴스 프로퍼티 : String 타입의 name, Int 타입의 age (둘다 가변)
> 타입 프로퍼티 : String 타입의 interest 
> 타입 메소드 : typeMethod()
